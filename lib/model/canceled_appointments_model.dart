class CanceledAppointmentsModel {

  String message;
  List<CanceledAppointmentsData> data;
  bool status;

  CanceledAppointmentsModel({this.message, this.data, this.status});

  CanceledAppointmentsModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = new List<CanceledAppointmentsData>();
      json['data'].forEach((v) {
        data.add(new CanceledAppointmentsData.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class CanceledAppointmentsData {
  int id;
  String cityName;
  String countryName;
  String userId;
  ...
  CanceledAppointmentsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class CanceledAppointmentsModel {
  ...
  CanceledAppointmentsModel(this.image, this.title, this.rating, this.dateTime,
