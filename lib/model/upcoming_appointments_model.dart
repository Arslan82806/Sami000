class UpcomingAppointmentsModel {
  ...
  String message;
  List<UpcomingAppointmentsData> data;
  bool status;

  UpcomingAppointmentsModel({this.message, this.data, this.status});

  UpcomingAppointmentsModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = new List<UpcomingAppointmentsData>();
      json['data'].forEach((v) {
        data.add(new UpcomingAppointmentsData.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class UpcomingAppointmentsData {
  int id;
  String cityName;
  String countryName;
  String userId;
  ...
  UpcomingAppointmentsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class UpcomingAppointmentsModel {
  ...
  UpcomingAppointmentsModel(this.image, this.title, this.rating, this.dateTime,
      this.serviceStatus, this.serviceTypesList);
