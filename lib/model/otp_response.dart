class OTPResponse {
  ...
  OTPResponse({this.message, this.token, this.data, this.status});

  OTPResponse.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    token = json['Token'];
    data = json['data'] != null ? new OTPUserData.fromJson(json['data']) : null;
    status = json['status'];
  }
...
class OTPUserData {
  ...
  OTPUserData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
